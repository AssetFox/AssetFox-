        ...
        <div>
          <v-layout>
            ...
            <div class="edit-scenario-btns-div" v-if="$screen.freeRealEstate">
              ...
              <div>
                <v-btn @click="onShowCommittedProjectsFileUploader"
  ...
  onUploadCommittedProjectFiles(
    ...
    if (!isNil(result)) {
      CommittedProjectsService.saveCommittedProjectsFiles(
          ...
          '1189',
          '13',
      ) //this.selectedScenarioId.toString(), this.stateNetworks[0].networkId.toString()
    ...
    if (isExport) {
      ...
      //this.selectedScenario.networkId = 13; // this.stateNetworks[0].networkId;
