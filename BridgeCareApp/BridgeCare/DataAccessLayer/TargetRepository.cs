...
namespace BridgeCare.DataAccessLayer
{
    ...
    {
        private readonly TargetsMetRepository _targetsMetRepository;
        private readonly TargetResultsRepository targetCells;

        public TargetRepository(TargetsMetRepository targetsMetRepository, TargetResultsRepository targetCells)
        {
            this._targetsMetRepository = targetsMetRepository ?? throw new ArgumentNullException(nameof(targetsMetRepository));
        ...
        public TargetReportModel GetTarget(SimulationModel model, int[] totalYears, BridgeCareContext db)
        {
            ...
            var targetAndYear = _targetsMetRepository.GetData(deficientReportResults);
