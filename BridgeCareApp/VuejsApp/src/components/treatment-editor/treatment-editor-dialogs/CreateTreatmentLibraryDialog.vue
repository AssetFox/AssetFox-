...
export default class CreateTreatmentLibraryDialog extends Vue {
  ...
  newTreatmentLibrary: TreatmentLibrary = {...emptyTreatmentLibrary, id: getNewGuid()};
  ...
  onSubmit(submit: boolean) {
    if (submit) {
      this.$emit('submit', this.newTreatmentLibrary, this.dialogData.scenarioId);
    } else {
      this.$emit('submit', null);
    }

    this.newTreatmentLibrary = {...emptyTreatmentLibrary, id: getNewGuid()};
  }
}
</script>
