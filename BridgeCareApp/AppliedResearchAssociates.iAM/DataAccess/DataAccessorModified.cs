                ...
                using (var reader = command.ExecuteReader())
                {
                    ...
                    void createAttributes()
                    {
                        ...
                        foreach (var item in attributeMetaData)
                        {
                            ...
                            {
                                if (type.ToUpper() != NUMBER_ATTRIBUTE_TYPE_NAME)
                                {
                            ...
                            case NUMBER_ATTRIBUTE_TYPE_NAME:
                                ...
                                if (isCalculated)
                                {
                                    ...
                                    calculatedField.IsDecreasingWithDeterioration = item.IsAscending;
                                }
                                else
                                {
                                    var numberAttribute = simulation.Network.Explorer.AddNumberAttribute(name);
                                    numberAttribute.IsDecreasingWithDeterioration = item.IsAscending;
                                    numberAttribute.DefaultValue = double.Parse(item.DefaultValue);
                                    numberAttribute.Minimum = item.Minimum;
                                    numberAttribute.Maximum = item.Maximum;
