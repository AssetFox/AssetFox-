...
namespace AppliedResearchAssociates.iAM.UnitTestsCore.Tests
{
    ...
    // writing new simulation analysis tests. Furthermore, maintaining the code in
    // non-commented-out form was an obstacle to removing TestHelper,
    // so the test code is getting commented out as of 9/26/22.
    ...
    public class SimulationAnalysisDataPersistenceTests
    {
        ...
        //public BrokenSimulationAnalysisDataPersistenceTestHelper CreateTestHelper()
        //{
        //    return new BrokenSimulationAnalysisDataPersistenceTestHelper();
        //}
