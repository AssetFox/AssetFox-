<template>
    <v-layout>
                    ...
                    <v-layout column>
                            ...
                            <div class="validation-message-div">
                                <v-layout justify-center>
                                    <p
                                        ...
                                        v-if="invalidExpressionMessage !== ''"
                                    >
                                        {{ invalidExpressionMessage }}
                                    </p>
                                    <p
                                        class="valid-message"
                                        v-if="validExpressionMessage !== ''"
                                    >
                        ...
                        <v-flex xs12>
                            <v-tabs v-model="selectedTab">
                                <v-tab :key="0" @click="isPiecewise = false"
                                    >Equation</v-tab
                                >
                                <v-tab
                                    :key="1"
                                    @click="isPiecewise = true"
                                    :hidden="!isFromPerformanceCurveEditor"
                                    >Piecewise</v-tab
                                >
                                <v-tab
                                    :key="2"
                                                    ...
                                                    <div>
                                                        <v-list>
                                                            <template>
                                                                ...
                                                                >
                                                                <div
                                                                    class="attributes-list-container"
                                                                >
                                                                    <v-list-tile
                                                                        :key="
                                                                            attribute
                                            ...
                                            <v-flex xs4>
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        <v-btn
                                                            @click="
                                                                showAddMultipleDataPointsPopup = true
                                                            "
                                                            class="ara-blue-bg white--text"
                                                        >
                                                            Add Multi
                                                    ...
                                                    <div
                                                        class="data-points-grid"
                                                    >
                                                        <v-data-table
                                                            :headers="
                                                                piecewiseGridHeaders
                                                            "
                                                            :items="
                                                                piecewiseGridData
                                                            "
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <td
                                                                    v-for="header in piecewiseGridHeaders"
                                                                >
                                                                    <div
                                                                        v-if="
                                                                            header.value !==
                                                                    ...
                                                                    <div v-else>
                                                                        <v-btn
                                                                            @click="
                                                                                onRemoveTimeAttributeDataPoint(
                                                                                    props
                                                                                        .item
                                                                                        .id,
                                                                                )
                                            ...
                                            <v-flex xs8>
                                                ...
                                                >
                                                    <kendo-chart
                                                        ...
                                                        "
                                                        :pannable-lock="'y'"
                                                        :series-defaults-style="
                                                            'smooth'
                                                        "
                                                        :series-defaults-type="
                                                            'scatterLine'
                                                        "
                                                        :theme="'sass'"
                                                        :tooltip-format="
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <td
                                                                    v-for="header in timeInRatingGridHeaders"
                                                                >
                                                                    <div
                                                                        v-if="
                                                                            header.value !==
                        ...
                        <v-flex xs12>
                            <div>
                                <v-layout justify-space-between row>
                                    <v-btn
                                        :disabled="disableEquationCheck()"
                                        @click="onCheckEquation"
                                        class="ara-blue-bg white--text"
                                        >Check</v-btn
                                    >
                                    <v-btn
        ...
        <v-dialog max-width="250px" persistent v-model="showAddDataPointPopup">
            <v-card>
                    ...
                    <v-layout column justify-center>
                        ...
                        <div>
                            <v-text-field
                                ...
                                outline
                                type="number"
                                v-model="newDataPoint.conditionValue"
                            >
                            </v-text-field>
                        </div>
                    </v-layout>
                ...
                <v-card-actions>
                    <v-layout justify-space-between row>
                        <v-btn
                            :disabled="disableNewDataPointSubmit()"
                            @click="onSubmitNewDataPoint(true)"
                            class="ara-blue-bg white--text"
                        >
                            Save
                        </v-btn>
                        <v-btn
                            @click="onSubmitNewDataPoint(false)"
                            class="ara-orange-bg white--text"
                            >Cancel</v-btn
                        >
                    </v-layout>
        ...
        <v-dialog
            max-width="200px"
            persistent
            v-model="showAddMultipleDataPointsPopup"
        >
            <v-card>
                <v-card-text>
                    <v-layout column justify-center>
                        <p>
                            Data point entries must follow the format
                            <span class="format-span"
                                ><strong>#,#</strong></span
                            >
                            (time,attribute) with each entry on a separate line.
                        </p>
                        <v-flex xs2>
                            <v-textarea
                                :rules="[
                ...
                <v-card-actions>
                    <v-layout justify-space-between row>
                        <v-btn
                            :disabled="disableMultipleDataPointsSubmit()"
                            @click="onSubmitNewDataPointMulti(true)"
                            class="ara-blue-bg white--text"
                        >
                            Save
                        </v-btn>
                        <v-btn
                            @click="onSubmitNewDataPointMulti(false)"
                            class="ara-orange-bg white--text"
                            >Cancel
                        </v-btn>
                    </v-layout>
                    ...
                    <v-layout justify-center>
                        ...
                        <div v-else>
                            <v-text-field
                                ...
                                outline
                                type="number"
                                v-model="editedDataPoint.conditionValue"
                            >
                            </v-text-field>
                        </div>
                    </v-layout>
                ...
                <v-card-actions>
                    <v-layout justify-space-between row>
                        <v-btn
                            ...
                            @click="onSubmitEditedDataPointValue(true)"
                            class="ara-blue-bg white--text"
                        >
                            Save
                        </v-btn>
                        <v-btn
                            @click="onSubmitEditedDataPointValue(false)"
                            class="ara-orange-bg white--text"
                            >Cancel
                        </v-btn>
                    </v-layout>
...
import {
    emptyTimeConditionDataPoint,
    TimeConditionDataPoint,
} from '@/shared/models/iAM/time-condition-data-point';
import {
    add,
    clone,
    findIndex,
...
export default class EquationEditorDialog extends Vue {
    ...
    editedDataPoint: TimeConditionDataPoint = clone(
        emptyTimeConditionDataPoint,
    );
     ...
     */
    mounted() {
        this.textareaInput = document.getElementById(
            'equation_textarea',
    ...
    onDialogDataChanged() {
        this.equation = {
            id:
                this.dialogData.equation.id === this.uuidNIL
                    ? this.equation.id
                    : this.dialogData.equation.id,
            expression: !isNil(this.dialogData.equation.expression)
                ? this.dialogData.equation.expression
                : '',
        };
    ...
    onPiecewiseGridDataChanged() {
        ...
        let highestTimeValue: number = getLastPropertyValue(
            'timeValue',
        ...
        let highestConditionValue: number = getLastPropertyValue(
            'conditionValue',
            this.piecewiseGridData,
        );
        ...
        this.dataPointsSource = this.piecewiseGridData.map(
            (dataPoint: TimeConditionDataPoint) => [
                dataPoint.timeValue,
                dataPoint.conditionValue,
            ],
        );
    }
    ...
    onParsePiecewiseEquation() {
        ...
        const dataPointStrings: string[] = this.expression
            .split(this.piecewiseRegex)
            .filter(
                (dataPoint: string) =>
                    hasValue(dataPoint) && dataPoint.indexOf(',') !== -1,
            );
     ...
     */
    setAttributesList() {
        this.attributesList = getPropertyValues(
            'name',
    ...
    onAddFormulaToEquation(formula: string) {
        if (this.cursorPosition === 0) {
            ...
            const output = `${this.expression.substr(
                0,
                this.cursorPosition,
            )}${formula}`;
            this.expression = `${output}${this.expression.substr(
                this.cursorPosition,
            )}`;
            if (formula !== 'E' && formula !== 'PI') {
                let i = output.length;
    ...
    setTextareaCursorPosition() {
        setTimeout(() =>
            this.textareaInput.setSelectionRange(
                this.cursorPosition,
                this.cursorPosition,
            ),
        );
        ...
        if (submit) {
            const newParsedDataPoint: TimeConditionDataPoint = {
                ...
                conditionValue: parseFloat(
                    this.newDataPoint.conditionValue.toString(),
                ),
            };

            const dataPoints: TimeConditionDataPoint[] =
                this.selectedTab === 1
    ...
    syncDataGridLists(dataPoints: TimeConditionDataPoint[]) {
        ...
        if (this.selectedTab === 1) {
            piecewiseData = sortByProperty('timeValue', dataPoints).filter(
                (dataPoint: TimeConditionDataPoint) =>
                    dataPoint.timeValue !== 0,
            );

            piecewiseData.forEach(
                (dataPoint: TimeConditionDataPoint, index: number) => {
                    timeInRatingData.push({
                        ...
                        timeValue:
                            index === 0
                                ...
                                : Math.abs(
                                      piecewiseData[index - 1].timeValue -
                                          piecewiseData[index].timeValue,
                                  ),
                    });
                },
            ...
            timeInRatingData = reverse(
                sortByProperty('conditionValue', timeInRatingData),
            );
            ...
            if (hasValue(timeInRatingData)) {
                const n1: TimeConditionDataPoint = {
                    id: getNewGuid(),
                    timeValue: 0,
                    conditionValue: Math.trunc(
                        add(1, timeInRatingData[0].conditionValue),
                    ),
                };
    ...
    parseMultipleDataPoints() {
        ...
        if (hasValue(splitDataPoints)) {
            const dataPoints: TimeConditionDataPoint[] = splitDataPoints.map(
                (dataPoints: string) => {
    ...
    onSubmitEditedDataPointValue(submit: boolean) {
        if (submit) {
            let dataPoints =
                this.selectedTab === 1
                    ? clone(this.piecewiseGridData)
                    : clone(this.timeInRatingGridData);
            var timeValue = parseFloat(
                this.editedDataPoint.timeValue.toString(),
            );
            var conditionValue = parseFloat(
                this.editedDataPoint.conditionValue.toString(),
            );
            if (!isNaN(timeValue) && !isNaN(conditionValue)) {
                ...
                dataPoints = update(
                    findIndex(
                        propEq('id', this.editedDataPoint.id),
                        dataPoints,
                    ),
    ...
    onRemoveTimeAttributeDataPoint(id: string) {
        const dataPoints: TimeConditionDataPoint[] =
            this.selectedTab === 1
                ? this.piecewiseGridData.filter(
                      (dataPoint: TimeConditionDataPoint) =>
                          dataPoint.id !== id,
                  )
                : this.timeInRatingGridData.filter(
                      (dataPoint: TimeConditionDataPoint) =>
                          dataPoint.id !== id,
                  );
    ...
    disableEquationCheck() {
        return this.isPiecewise
            ? !hasValue(this.onParseTimeAttributeDataPoints())
            : !hasValue(this.expression);
    }
    ...
    onCheckEquation() {
        const equationValidationParameters: EquationValidationParameters = {
            expression: this.isPiecewise
                ? this.onParseTimeAttributeDataPoints()
                : this.expression,
            isPiecewise: this.isPiecewise,
            currentUserCriteriaFilter: { ...emptyUserCriteriaFilter },
        };

        ValidationService.getEquationValidationResult(
            equationValidationParameters,
    ...
    onParseTimeAttributeDataPoints() {
        return this.piecewiseGridData
            .map(
                (timeAttributeDataPoint: TimeConditionDataPoint) =>
    ...
    onSubmit(submit: boolean) {
        ...
        if (submit) {
            this.equation.expression = this.isPiecewise
                ? this.onParseTimeAttributeDataPoints()
                : this.expression;
    ...
    disableNewDataPointSubmit() {
        return (
            this.timeValueIsNotEmpty(this.newDataPoint.timeValue.toString()) !==
                true ||
            this.timeValueIsGreaterThanZero(
                this.newDataPoint.timeValue.toString(),
            ) !== true ||
            this.timeValueIsNew(this.newDataPoint.timeValue.toString()) !==
                true ||
            this.conditionValueIsNotEmpty(
                this.newDataPoint.conditionValue.toString(),
            ) !== true ||
            this.conditionValueIsNew(
                this.newDataPoint.conditionValue.toString(),
            ) !== true
        );
    }
    ...
    timeValueIsGreaterThanZero(value: string) {
        return (
            parseInt(value) > 0 ||
            'Time values cannot be less than or equal to 0'
        );
    }
    ...
    timeValueIsNew(value: string) {
        if (this.selectedTab === 1) {
            const timeValues: number[] = getPropertyValues(
                'timeValue',
                this.piecewiseGridData,
            );

            return (
                timeValues.indexOf(parseInt(value)) === -1 ||
                'Time value already exists'
            );
        }
    ...
    conditionValueIsNew(value: string) {
        ...
        return (
            conditionValues.indexOf(parseFloat(value)) === -1 ||
            'Condition value already exists'
        );
    }
    ...
    isCorrectMultipleDataPointsFormat() {
        const eachDataPointIsValid = this.multipleDataPoints
            ...
            .every((dataPoints: string) => {
                return (
                    this.multipleDataPointsRegex.test(dataPoints) &&
                    dataPoints
                        .split(',')
                        .every((value: string) => !isNaN(parseFloat(value)))
                );
            });
    ...
    multipleDataPointsAreNew() {
        ...
        const eachDataPointIsNew = dataPoints.every(
            (dataPoint: TimeConditionDataPoint) => {
                const conditionValueIsNew =
                    this.conditionValueIsNew(
                        dataPoint.conditionValue.toString(),
                    ) === true;
                const timeValueIsNew: boolean =
                    this.timeValueIsNew(dataPoint.timeValue.toString()) ===
                    true;
        ...
        if (!isEmpty(existingConditionValues)) {
            conditionValuesAlreadyExistsMessage =
                'The following condition values already exist: ';
        ...
        if (!isEmpty(existingTimeValues)) {
            timeValuesAlreadyExistsMessage =
                'The following time values already exist: ';
