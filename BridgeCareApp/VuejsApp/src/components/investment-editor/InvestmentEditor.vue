<template>
    <v-layout column>
        <v-flex xs12>
            <v-layout row style="margin-top:-40px;">
                <v-flex xs4 class="ghd-constant-header">
                    ...
                    <v-select 
                        id="InvestmentEditor-select-investmentLibrary"
            ...
            <v-layout row style="margin-top:-20px;">
                ...
                <v-flex xs2 v-if='hasInvestmentPlanForScenario' class="ghd-constant-header">
                    ...
                    <v-text-field id="InvestmentEditor-textField-firstYearAnalysisPeriod"
                                  outline
                ...
                <v-flex xs2 v-if='hasInvestmentPlanForScenario' class="ghd-constant-header">
                    ...
                    <v-text-field id="InvestmentEditor-textField-numberYearsAnalysisPeriod"
                                  readonly outline
                ...
                <v-flex xs2 v-if='hasInvestmentPlanForScenario' class="ghd-constant-header">
                    ...
                    <v-text-field outline 
                                  id='InvestmentEditor-textField-minimumProjectCostLimit'
                ...
                <v-flex xs2 v-if='hasInvestmentPlanForScenario' class="ghd-constant-header">
                    ...
                    <v-text-field id="InvestmentEditor-textField-inflationRatePercentage"
                                  outline
                ...
                <v-flex xs4 v-if='hasInvestmentPlanForScenario' class="ghd-constant-header">
                    <v-switch id="InvestmentEditor-switch-allowFundingCarryover"
            ...
            <v-layout row justify-space-between v-show='hasSelectedLibrary || hasScenario'>
                <v-flex xs4>
                    <v-layout row>
                        ...
                        <v-btn id="InvestmentEditor-btn-addBudgetYearRange"
                ...
                <v-flex xs4>
                    <v-layout row align-end>
                        <v-spacer></v-spacer>
                        <v-btn id="InvestmentEditor-btn-upload"
                        ...
                        <v-btn id="InvestmentEditor-btn-download"
                        ...
                        <v-btn id="InvestmentEditor-btn-downloadTemplate"
        ...
        <!-- datatable -->
            <v-flex >
                <v-data-table 
                    id="InvestmentEditor-dataTable-investmentsDataTable"
                ...
                <v-btn id="InvestmentEditor-btn-deleteSelected"
        ...
        <v-flex xs12>
            <v-layout justify-center row v-show='hasSelectedLibrary || hasScenario'>
                ...
                <v-btn id="InvestmentEditor-btn-updateLibrary"
                ...
                <v-btn id="InvestmentEditor-btn-save"
