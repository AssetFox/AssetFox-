    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Output = table.Column<byte[]>(nullable: true),
                    SimulationId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimulationOutput", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionLibrary_Treatment", x => new { x.CriterionLibraryId, x.TreatmentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriterionLibrary_Treatment_SelectableTreatment_TreatmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentConsequence_SelectableTreatment_TreatmentId",
                        column: x => x.TreatmentId,
                        principalTable: "SelectableTreatment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    InvestmentPlanId = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Budget_InvestmentPlan_InvestmentPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CriterionLibraryId = table.Column<Guid>(nullable: false),
                    TreatmentConsequenceId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionLibrary_TreatmentConsequence", x => new { x.CriterionLibraryId, x.TreatmentConsequenceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriterionLibrary_TreatmentConsequence_TreatmentConsequence_TreatmentConsequenceId",
                        column: x => x.TreatmentConsequenceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatmentConsequence_Equation", x => new { x.TreatmentConsequenceId, x.EquationId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentConsequence_Equation_TreatmentConsequence_TreatmentConsequenceId",
                        column: x => x.TreatmentConsequenceId,
                        principalTable: "TreatmentConsequence",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommittedProject_SelectableTreatment_SelectableTreatmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Treatment_Budget", x => new { x.TreatmentId, x.BudgetId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Treatment_Budget_SelectableTreatment_TreatmentId",
                        column: x => x.TreatmentId,
                        principalTable: "SelectableTreatment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budget_InvestmentPlanId",
                table: "Budget",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashFlowRule_Name",
                table: "CashFlowRule",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashFlowRuleLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommittedProject_SelectableTreatmentId",
                table: "CommittedProject",
                column: "SelectableTreatmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CriterionLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriterionLibrary_Treatment_TreatmentId",
                table: "CriterionLibrary_Treatment",
                column: "TreatmentId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriterionLibrary_TreatmentConsequence_TreatmentConsequenceId",
                table: "CriterionLibrary_TreatmentConsequence",
                column: "TreatmentConsequenceId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeficientConditionGoal_Name",
                table: "DeficientConditionGoal",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeficientConditionGoalLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceCurveLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RemainingLifeLimitLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectableTreatment_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TargetConditionGoal_Name",
                table: "TargetConditionGoal",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TargetConditionGoalLibrary_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Treatment_Budget_TreatmentId",
                table: "Treatment_Budget",
                column: "TreatmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentConsequence_TreatmentId",
                table: "TreatmentConsequence",
                column: "TreatmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentConsequence_Equation_TreatmentConsequenceId",
                table: "TreatmentConsequence_Equation",
                column: "TreatmentConsequenceId",
                unique: true);
