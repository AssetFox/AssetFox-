...
namespace AppliedResearchAssociates.iAM.DataPersistenceCore.Repositories.MSSQL.Mappers
{
    public static class BudgetAmountMapper
    {
        ...
        public static ScenarioBudgetAmountEntity ToScenarioEntity(this BudgetAmountDTO dto, Guid budgetId) =>
            new ScenarioBudgetAmountEntity { Id = dto.Id, ScenarioBudgetId = budgetId, Value = dto.Value, Year = dto.Year };
