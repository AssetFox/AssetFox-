            ...
            <v-layout column justify-center>
                <v-flex xs10 class='criteria-flex'>
                    <v-menu full-width bottom min-height='500px' min-width='800px'>
                            ...
                            <v-text-field readonly full-width class='sm-txt' label='Treatment Criteria'
                                ...
                                <template slot='append-outer'>
                                    <v-layout align-center fill-height row>
                                        <v-btn @click='onShowTreatmentCriterionLibraryEditorDialog' class='edit-icon'
                                               icon>
                        ...
                        <v-card>
                            <v-card-text>
                                <v-textarea :value='selectedTreatmentDetails.criterionLibrary.mergedCriteriaExpression'
                                            full-width
                                            no-resize
                                            outline
                                            readonly
