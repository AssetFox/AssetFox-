...
AS 
	...
	Begin Transaction
		...
		Delete FROM dbo.[AggregatedResult] WHERE NOT EXISTS (SELECT * FROM dbo.[Attribute] AS parent WHERE parent.Id = [AggregatedResult].AttributeId);
		...
		Delete FROM dbo.[CriterionLibrary_ScenarioTreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[CriterionLibrary] AS parent WHERE parent.Id = [CriterionLibrary_ScenarioTreatmentSupersession].CriterionLibraryId);
		...
		Delete FROM dbo.[CriterionLibrary_TreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[CriterionLibrary] AS parent WHERE parent.Id = [CriterionLibrary_TreatmentSupersession].CriterionLibraryId);
		...
		Delete FROM dbo.[TreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[CriterionLibrary_ScenarioTreatmentSupersession] AS parent WHERE parent.CriterionLibraryId = [TreatmentSupersession].CriterionLibraryScenarioTreatmentSupersessionJoinCriterionLibraryId);
		Delete FROM dbo.[TreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[CriterionLibrary_ScenarioTreatmentSupersession] AS parent WHERE parent.CriterionLibraryId = [TreatmentSupersession].CriterionLibraryScenarioTreatmentSupersessionJoinTreatmentSupersessionId);
		...
		Delete FROM dbo.[AggregatedResult] WHERE NOT EXISTS (SELECT * FROM dbo.[MaintainableAsset] AS parent WHERE parent.Id = [AggregatedResult].MaintainableAssetId);
		...
		Delete FROM dbo.[ScenarioTreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[ScenarioSelectableTreatment] AS parent WHERE parent.Id = [ScenarioTreatmentSupersession].TreatmentId);
		...
		Delete FROM dbo.[CriterionLibrary_ScenarioTreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[ScenarioTreatmentSupersession] AS parent WHERE parent.Id = [CriterionLibrary_ScenarioTreatmentSupersession].TreatmentSupersessionId);
		...
		Delete FROM dbo.[TreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[SelectableTreatment] AS parent WHERE parent.Id = [TreatmentSupersession].TreatmentId);
		...
		Delete FROM dbo.[CriterionLibrary_TreatmentSupersession] WHERE NOT EXISTS (SELECT * FROM dbo.[TreatmentSupersession] AS parent WHERE parent.Id = [CriterionLibrary_TreatmentSupersession].TreatmentSupersessionId);
