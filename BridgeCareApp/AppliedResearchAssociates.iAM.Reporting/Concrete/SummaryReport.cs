...
namespace AppliedResearchAssociates.iAM.Reporting
{
    public class SummaryReport : IReport
    {
        ...
        public SummaryReport(IBridgeDataForSummaryReport bridgeDataForSummaryReport, ILogger<SummaryReportGenerator> logger,
            IUnfundedTreatmentFinalList unfundedTreatmentFinalList, IUnfundedTreatmentTime unfundedTreatmentTime,
            ...
            IAddGraphsInTabs addGraphsInTabs, UnitOfDataPersistenceWork unitOfWork,
            IHubService hubService, IHttpContextAccessor httpContextAccessor, string name, ReportIndexEntity results)
        {
