...
namespace AppliedResearchAssociates.iAM.UnitTestsCore.TestUtils
{
    public class SimulationAnalysisDataPersistenceTestHelper : TestHelper
    {
        ...
        public void SetStandAloneSimulation(int simulationId)
        {
            ...
            UnitOfWorkForAnalysis.AnalysisMethodRepo.GetSimulationAnalysisMethod(StandAloneSimulation, null); // Added the "null" here to fix the build. No idea if it's correct for the test or not -- WJ.
