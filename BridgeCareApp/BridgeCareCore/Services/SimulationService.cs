...
namespace BridgeCareCore.Services
{
    public class SimulationService : ISimulationService
    {
        ...
        public PagingPageModel<QueuedSimulationDTO> RetrieveSimulationQueue(PagingRequestModel<QueuedSimulationDTO> request, string role)
        {
            var skip = 0;
            var take = 0;
            ...
            // TODO: get simulations currently in queue

            // TODO: query/match simulations in DB

            //AnalysisWorkItem.Id == Simulation.Id
            ...
            var simulations = _unitOfWork.Context.Simulation
                ...
                .Where(_ => _.Owner == _unitOfWork.CurrentUser.Username).Cast<QueuedSimulationDTO>().ToList();


            if (request.search.Trim() != "")
                simulations = SearchSimulations(simulations, request.search); // TODO: Should this be updated/refactored?
            if (request.sortColumn.Trim() != "")
                simulations = OrderByColumn(simulations, request.sortColumn, request.isDescending); // TODO: Should this be updated/refactored
