...
{
    public class CriteriaDrivenBudgetsRepository : ICriteriaDrivenBudgetsRepository
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(CriteriaDrivenBudgetsRepository));
        /// <summary>
