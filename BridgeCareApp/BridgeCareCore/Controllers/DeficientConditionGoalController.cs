...
namespace BridgeCareCore.Controllers
{
    ...
    public class DeficientConditionGoalController : BridgeCareCoreBaseController
    {
        ...
        public async Task<IActionResult> GetScenarioDeficientConditionGoals(Guid simulationId)
        {
            ...
            {
                HubService.SendRealTimeMessage(UserInfo.Name, HubConstant.BroadcastError, $"{DeficientConditionGoalError}::GetScenarioDeficientConditionGoals - {e.Message}");
                throw;
            }
        }
        ...
        public async Task<IActionResult> GetScenarioDeficientConditionGoalPage(Guid simulationId, PagingRequestModel<DeficientConditionGoalDTO> pageRequest)
        {
            ...
            {
                HubService.SendRealTimeMessage(UserInfo.Name, HubConstant.BroadcastError, $"{DeficientConditionGoalError}::GetScenarioDeficientConditionGoalPage - {e.Message}");
                return Ok();
            }
            catch (Exception e)
            {
