        ...
        <v-layout justify-space-between>
          ...
          <v-flex xs4 class="ghd-constant-header">
                    <v-layout v-if="hasSelectedLibrary && !hasScenario" style="padding-top: 18px; padding-left: 5px" align-center>
                        ...
                        <v-btn @click='onShowShareRemainingLifeLimitLibraryDialog(selectedRemainingLifeLimitLibrary)' class='ghd-blue ghd-button-text ghd-outline-button-padding ghd-button' variant = "outline"
                            v-show='!hasScenario'>
                            Share Library
                        </v-btn>
                    </v-layout>
                ...
                <v-layout justify-end align-end style="padding-top: 18px !important;">
                    <div>
                        <v-btn id="RemainingLifeLimitEditor-addRemainingLifeLimit-btn" class="ghd-white-bg ghd-blue ghd-button" @click="onShowCreateRemainingLifeLimitDialog" v-show="librarySelectItemValue != null || hasScenario" variant = "outline">Add Remaining Life Limit</v-btn>
                        <v-btn class='ghd-blue ghd-button-text ghd-outline-button-padding ghd-button' style ="ri"  @click="onShowCreateRemainingLifeLimitLibraryDialog(false)" v-show="!hasScenario" variant = "outline">Create New Library</v-btn>
                    </div>
                </v-layout>
                </v-flex>
            </v-layout>
        ...
        <div v-show="librarySelectItemValue != null || hasScenario">
            ...
            >
                ...
                <v-layout justify-center row>
                    <v-btn id="RemainingLifeLimitEditor-cancel-btn" class="ghd-blue" variant = "outline" v-show="hasScenario" @click="onDiscardChanges" :disabled="!hasUnsavedChanges">Cancel</v-btn>
                    <v-btn id="RemainingLifeLimitEditor-deleteLibrary-btn" class="ghd-blue" variant = "outline" v-show="!hasScenario" @click="onShowConfirmDeleteAlert">Delete Library</v-btn>
                    <v-btn id="RemainingLifeLimitEditor-createAsNewLibrary-btn" class='ghd-blue ghd-button-text ghd-outline-button-padding ghd-button' @click="onShowCreateRemainingLifeLimitLibraryDialog(true)" variant = "outline">Create as New Library</v-btn>
