...
{
    public class SectionLocatorRepository : ISectionLocatorRepository
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(SectionLocatorRepository));
        public SectionLocatorRepository()
        {
        }
